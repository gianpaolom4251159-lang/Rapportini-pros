...
# ==========================================
# GESTIONE DATABASE SQLITE (SENZA XML)
# ==========================================
class PDFDatabase:
    ...
    def registra_carico_ddt(self, filepath: str, doc_number: str, doc_date: str, articoli: List[Dict[str, Any]]) -> int:
        ...
        try:
            ...
            # Inserimento righe e aggiornamento giacenze
            for art in articoli:
                codice = art['codice']
...
def upload_ddt():
    ...
    if not articoli:
        return jsonify({
            "success": False, 
            "error": "Nessun articolo valido trovato nel PDF (verifica che i codici nel PDF inizino con 'ART-')."
        }), 400
